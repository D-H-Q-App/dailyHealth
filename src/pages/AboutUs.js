  ...
  return (
    <div className="main">
      ...
      <img src="./images/about.png" style={{
        ...
        <p>If this sounds like something you would like to accomplish, take this quiz as often as you like and if you're interested in working with an Ayurvedic Practitioner I highly suggest Julie Bernier or any of the practioners or doctors at Kerala. https://www.keralaayurveda.us/wellnesscenter/natural-healing-and-prakriti-your-ayurvedic-constitution/  Let’s get started living your happiest and healthiest life.</p>
      </div>
    </div>
  );
}
